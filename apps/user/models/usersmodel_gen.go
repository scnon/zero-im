...
var (
	...
	cacheZeroImUsersIdPrefix = "cache:zeroIm:users:id:"
)
...
func (m *defaultUsersModel) Delete(ctx context.Context, id string) error {
	zeroImUsersIdKey := fmt.Sprintf("%s%v", cacheZeroImUsersIdPrefix, id)
...
func (m *defaultUsersModel) Insert(ctx context.Context, data *Users) (sql.Result, error) {
	zeroImUsersIdKey := fmt.Sprintf("%s%v", cacheZeroImUsersIdPrefix, data.Id)
...
func (m *defaultUsersModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheZeroImUsersIdPrefix, primary)
}
